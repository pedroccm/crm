...
export default function CamposLeadsPage() {
  ...
  async function loadFields() {
    try {
      ...
      const data = await listCustomFields(currentTeam.id, 'lead')
      setFields(data)
    } catch (error: any) {
  ...
  async function handleMoveField(field: CustomFieldDefinition, direction: 'up' | 'down') {
    ...
    try {
      ...
      await reorderCustomFields(currentTeam.id, 'lead', fieldIds)
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>Campos de Leads</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <h1 className="text-2xl font-semibold">Campos de Leads</h1>
              <p className="text-sm text-muted-foreground">
                Configure campos personalizados para leads
              </p>
            </div>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground max-w-md mt-2">
                    Crie campos personalizados para coletar informações adicionais sobre seus leads.
                  </p>
            ...
            <DialogHeader>
              ...
              <DialogDescription>
                {isEditing 
                  ...
                  : "Configure um novo campo personalizado para leads"}
              </DialogDescription>
            </DialogHeader>
